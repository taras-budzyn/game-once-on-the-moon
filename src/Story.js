class Story extends Phaser.Scene {
    ...
    create() {
		...
		buttonContinue.x = MON.world.width+buttonContinue.width+20;
		this.tweens.add({targets: buttonContinue, x: MON.world.width-20, duration: 500, ease: 'Back'});
	...
	clickContinue() {
		...
		MON.fadeOutScene(level ? level : 'Level1', this);
	}
};